...
<div class="jumbotron">
    <h1 class="display-4">Welcome to the Women Techpower Platform!</h1>
    <p class="lead">Promotes women in the field of technology by providing educational resources, networking opportunities and professional development.</p>
