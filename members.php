...
// Determine page status (default is 'member')
$pageStatus = 'member'; // Default status
...
<div class="search-options">
    <form method="GET">
        ...
        <a href="members.php?status=<?php echo htmlspecialchars($pageStatus); ?>" class="btn btn-primary">Reset</a>
    </form>
</div>
<br/>
